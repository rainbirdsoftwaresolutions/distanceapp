...
public class DistanceAppControllerTest {
    ...
    private Person testPerson1 = new Person(1, "John", "Smith", "here@there.com", "127.0.0.1", BigDecimal.ZERO, BigDecimal.ZERO);
    private Person testPerson2 = new Person(2, "Paul", "Smith", "here@there.com", "127.0.0.1", BigDecimal.ZERO, BigDecimal.ZERO);
    private Person testPerson3 = new Person(3, "George", "Smith", "here@there.com", "127.0.0.1", BigDecimal.ZERO, BigDecimal.ZERO);
    private Person testPerson4 = new Person(4, "Ringo", "Smith", "here@there.com", "127.0.0.1", BigDecimal.ZERO, BigDecimal.ZERO);
